					...
					<div class="col-md-12">
						<div class="mu-page-breadcrumb-area">
							...
							<ol class="breadcrumb">
								...
								<li class="active">Blog Archive {{ page }}, skip {{skip}}</li>
							</ol>
						</div>
					</div>
				</div>
...
<!--														<a href="#"><img :src="`images/news/${article.img}`" alt="img"></a>-->
													...
													<div class="mu-blog-meta">
														<a href="#">By {{ article.author.name }}</a>
														<a href="#">{{ formatDate(article.createdAt) }}</a>
														<span><i class="fa fa-comments-o"></i>87</span>
													</div>
													<div class="mu-blog-description">
<!--														<p>{!! limitString(strip_tags($news->content), 100) !!}</p>-->
														<nuxt-link class="mu-read-more-btn" :to="{name: 'article-slug', params: {slug: article.slug} }">Read More</nuxt-link>
													</div>
												</article>
											</div>
<!--											@empty-->
